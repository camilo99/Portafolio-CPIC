			...
			<div class="modal-body">
				<div class="owl-carousel owl-loaded owl-drag">
					<div class="owl-stage-outer">
						<div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: 0.25s; width: 1185px;"><div class="owl-item active" style="width: 355px; margin-right: 40px;"><div class="news-container">
							<figure>
								<div class="news-image-container">
									<img class="photo-news" src="{{asset('imgs/hero.jpg')}}" alt="photo-news">                                        
								</div>
								...
								</div></div><div class="owl-item active" style="width: 355px; margin-right: 40px;"><div class="news-container">
								<figure>
									<div class="news-image-container">
										<img class="photo-news" src="{{asset('imgs/bgc.png')}}" alt="photo-news">                                        
									</div>
									<div class="news-description">
								...
								</div></div><div class="owl-item" style="width: 355px; margin-right: 40px;"><div class="news-container">
								<figure>
									<div class="news-image-container">
										<img class="photo-news" src="{{asset('imgs/learn_1.jpg')}}" alt="photo-news">                                       
								 	</div>
										<div class="news-description">
